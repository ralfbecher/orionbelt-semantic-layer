"""PEP 249 Connection wrapping ``snowflake.connector.connection.SnowflakeConnection``."""
...
from ob_snowflake.exceptions import ProgrammingError


class Connection:
    """DB-API 2.0 connection that wraps a native Snowflake connector connection.
